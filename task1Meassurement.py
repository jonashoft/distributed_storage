...
def test_upload_and_download(strategy, k, N):
    ...
    time.sleep(5)
    kb100id, smallFileList = upload_file('kb100.txt', strategy)
    ...
    mb1Id, mediumFileList = upload_file('mb1.txt', strategy)
    ...
    mb10Id, largeFileList = upload_file('mb10.txt', strategy)
    ...
    mb100Id, extraLargeFileList = upload_file('mb100.txt', strategy)
    ...
    smallDownloadList, wrongFragmentsSmall = download_file(kb100id)
    ...
    mediumDownloadList, wrongFragmentsMedium = download_file(mb1Id)
    ...
    largeDownloadList, wrongFragmentsLarge = download_file(mb10Id)
    ...
    xlDownloadList, wrongFragmentsXL = download_file(mb100Id)
